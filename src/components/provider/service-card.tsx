    ...
    <Card className="p-5 bg-card border-border flex flex-col gap-4 hover:border-blue-500/40 transition-all duration-200 hover:shadow-[0_0_20px_rgba(59,130,246,0.08)]">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-foreground text-base truncate">{service.title}</h3>
          <p className="text-muted-foreground text-sm mt-0.5 line-clamp-2">{service.description}</p>
        </div>
        <span
